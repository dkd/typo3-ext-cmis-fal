<?php
namespace Dkd\CmisFal\Driver\Versioned;

use Dkd\CmisFal\Driver\CMISFilesystemDriverInterface;
use Dkd\CmisFal\Driver\SubAssertionDriver;
use Dkd\CmisFal\Driver\SubCreationDriver;
use Dkd\CmisFal\Driver\SubDeletionDriver;
use Dkd\CmisFal\Driver\SubModificationDriver;
use Dkd\CmisFal\Driver\SubResolvingDriver;
use Dkd\CmisFal\Driver\SubTransferDriver;
 ...
 */
abstract class AbstractSharedCMISFilesystemDriver extends AbstractHierarchicalFilesystemDriver implements CMISFilesystemDriverInterface {
    ...
    public function getSession() {
        ...
        try {
            ...
            $registryObject->set('core', 'sys_file_storage-' . $this->storageUid . '-offline-until', time() + 60 * 1);
            throw $error;
        }
    }
