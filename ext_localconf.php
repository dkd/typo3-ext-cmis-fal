...
(function() {
    ...
    if (version_compare(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getExtensionVersion('core'), 8, '>=')) {
        $driverClassName = \Dkd\CmisFal\Driver\Versioned\V8\CMISFilesystemDriver::class;
    }
